...
driver = webdriver.Remote('http://127.0.0.1:4723/wd/hub',CSH_Emulator_data())
#使用SDK模拟器进行自动化测试
...
driver = webdriver.Remote('http://127.0.0.1:4723/wd/hub',CSH_Real_data())
#使用真机进行自动化测试
'''
